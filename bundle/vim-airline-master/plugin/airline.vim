...
call s:check_defined('g:airline_left_sep', exists('g:airline_powerline_fonts')?"Ǘ":">")
call s:check_defined('g:airline_left_alt_sep', exists('g:airline_powerline_fonts')?"Ǚ":">")
call s:check_defined('g:airline_right_sep', exists('g:airline_powerline_fonts')?"Ǜ":"<")
call s:check_defined('g:airline_right_alt_sep', exists('g:airline_powerline_fonts')?"ǚ":"<")
...
call s:check_defined('g:airline_branch_prefix', exists('g:airline_powerline_fonts')?'ǋ ':'')
call s:check_defined('g:airline_readonly_symbol', exists('g:airline_powerline_fonts')?'ǌ':'RO')
call s:check_defined('g:airline_linecolumn_prefix', exists('g:airline_powerline_fonts')?'Ǌ ':':')
call s:check_defined('g:airline_paste_symbol', (exists('g:airline_powerline_fonts') ? 'Ǚ ' : '').'PASTE')
